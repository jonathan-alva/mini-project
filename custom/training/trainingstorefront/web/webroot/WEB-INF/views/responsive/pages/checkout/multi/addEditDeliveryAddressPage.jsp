                    ...
                    <div class="row">
                                ...
                                <jsp:body>
                                    <ycommerce:testId code="checkoutStepOne">
                                        <div class="checkout-shipping">
                                            ...
                                            <div class="checkout-indent">
                                                <div class="headline"><spring:theme
                                                        code="checkout.summary.shippingAddress"/></div>
                                                ...
                                                <div id="addressbook">
                                                    ...
                                                    <c:forEach items="${deliveryAddresses}" var="deliveryAddress"
                                                        ...
                                                        <div class="addressEntry">
                                                            <form action="${fn:escapeXml(selectDeliveryAddressUrl)}"
                                                                  method="GET">
                                        ...
                                        <button id="addressSubmit" type="button"
                                                class="btn btn-block btn-brand checkout-next"><spring:theme
                        ...
                        <div class=" col-sm-5 col-lg-4 hidden-xs" >
                            <multi-checkout:checkoutOrderDetails cartData="${cartData}" showDeliveryAddress="false"
                                                                 showPaymentInfo="false" showTaxEstimate="false"
                                                                 showTax="true"/>
                        </div>
