                                    ...
                                    <ycommerce:testId code="checkoutStepTwo">
                                        <div class="checkout-shipping">
                                            ...
                                            <div class="checkout-indent">
                                                ...
                                                <form id="selectDeliveryMethodForm" action="${fn:escapeXml(selectDeliveryMethodUrl)}"
                                                      method="get">
                                        ...
                                        <button id="deliveryMethodSubmit" type="button" class="btn btn-brand btn-block checkout-next">
