...
<div class="${fn:escapeXml(productTagClasses)}">
    <div class="plp">
        <div class="container-fluid plp-con">
            <ycommerce:testId code="product_wholeProduct">
                ...
                <div class="plp-details">
                    <div class="plp-details-brand">
                        <b href="${fn:escapeXml(productUrl)}"><c:out
                                value="${ycommerce:sanitizeHTML(product.brand)}"/></b>
                    </div>


                    <ycommerce:testId code="product_productName">
                        <a class="plp-details-name" href="${fn:escapeXml(productUrl)}">
                    ...
                    <div class="plp-details-size">${ycommerce:sanitizeHTML(product.size)}</div>

                    <ycommerce:testId code="product_productPrice">
                        <div class="plp-details-price"><product:productListerItemPrice product="${product}"/></div>
                    </ycommerce:testId>
